                                            ...
                                            <div class="bui-group bui-group--small">
                                                ...
                                                <ul class="bui-list bui-list--text bp-list--compact">
                                                    ...
                                                    <li class="bui-list__item">
                                                        <div>
                                                           {{ count($room->sub_rooms) }} &#215; {{ $room->room_types->type }}
                                                        </div>
                                                    </li>
                                                    @endforeach
                                                </ul>
                            ...
                            <div class="booking-main-contanet my-2">
                                ...
                                <form action="{{ URL('/booking/submit') }}" method="post">
                                    ...
                                    <div class="card booking-customer-form my-3">
                                        <div class="card-body">
                                            <div class="clearfix">
                                                <h5 class="booking-card-title float-left">{{ $room->room_types->type }}</h5>
                                                ...
                                                <div class="sub-room-facility my-2">
                                                    <ul>
                                                        <div class="d-flex flex-row flex-wrap align-items-md-center mb-2">
                                                            @foreach ($room->room_facilities as $facility)
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex flex-column">
                                                ...
                                                <div class="payment-type">
                                                    <div class="form-group">
                                                        <input type="radio" id="online" name="paymentType" value="1" checked>
                                                          <label for="online">Pay Online</label><br>
                                                          <input type="radio" id="offline" name="paymentType" value="2">
                                    ...
                                    <button type="submit" class="btn btn-primary float-right mb-2">Complete Payment</button>
                                </form>
                            </div>
                        </div>
                    </div>
