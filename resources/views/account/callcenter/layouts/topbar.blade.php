    ...
    <ul class="list-unstyled topnav-menu float-right mb-0">
        ...
        <li class="dropdown notification-list dropdown d-none d-lg-inline-block ml-2">
            <a class="nav-link dropdown-toggle mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                <img src="{{ URL('dashboard_assets/images/flags/us.jpg') }}" alt="lang-image" height="12">
            </a>
            <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                <!-- item-->
                <a href="javascript:void(0);" class="dropdown-item notify-item">
                    <img src="{{ URL('dashboard_assets/images/flags/germany.jpg') }}" alt="lang-image" class="mr-1" height="12"> <span
                        class="align-middle">German</span>
                </a>

                <!-- item-->
                <a href="javascript:void(0);" class="dropdown-item notify-item">
                    <img src="{{ URL('dashboard_assets/images/flags/italy.jpg') }}" alt="lang-image" class="mr-1" height="12"> <span
                        class="align-middle">Italian</span>
                </a>

                <!-- item-->
                <a href="javascript:void(0);" class="dropdown-item notify-item">
                    <img src="{{ URL('dashboard_assets/images/flags/spain.jpg') }}" alt="lang-image" class="mr-1" height="12"> <span
                        class="align-middle">Spanish</span>
                </a>

                <!-- item-->
                <a href="javascript:void(0);" class="dropdown-item notify-item">
                    <img src="{{ URL('dashboard_assets/images/flags/russia.jpg') }}" alt="lang-image" class="mr-1" height="12"> <span
                    ...
                    <div class="inbox-widget">
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="{{ URL('dashboard_assets/images/users/avatar-1.jpg') }}" class="rounded-circle" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="{{ URL('dashboard_assets/images/users/avatar-2.jpg') }}" class="rounded-circle" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="{{ URL('dashboard_assets/images/users/avatar-3.jpg') }}" class="rounded-circle" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="{{ URL('dashboard_assets/images/users/avatar-4.jpg') }}" class="rounded-circle" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="{{ URL('dashboard_assets/images/users/avatar-5.jpg') }}" class="rounded-circle" alt=""></div>
    ...
    <div class="logo-box">
        <a href="index.html" class="logo text-center logo-dark">
            ...
            <span class="logo-sm">
                            ...
                            <img src="{{ URL('dashboard_assets/images/logo-sm.png') }}" alt="" height="24">
                        </span>
        </a>

        <a href="index.html" class="logo text-center logo-light">
                        <span class="logo-lg">
                            <img src="{{ URL('dashboard_assets/images/logo-light.png') }}" alt="" height="22">
                            <!-- <span class="logo-lg-text-dark">Gimanhal</span> -->
                        </span>
            <span class="logo-sm">
                            <!-- <span class="logo-lg-text-dark">U</span> -->
                            <img src="{{ URL('dashboard_assets/images/logo-sm-light.png') }}" alt="" height="24">
                        </span>
        </a>
    </div>
