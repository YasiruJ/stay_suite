...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    <h4 class="header-title">Call Center Details</h4>
                    <p class="sub-header">
                    ...
                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> <a href="{{ URL('admin/call_center/edit/'.$user->id) }}"><button class="btn waves-effect waves-light btn-warning"><i class="mdi mdi-wrench"></i> </button></a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
...
<script>
    ...
    $(".js-switch").on('change', function() {
        ...
        $.ajax({
            url: "{{ url('admin/call_center/status/update') }}" + '/' + callCenterID,
            type: 'POST',
            data: {
