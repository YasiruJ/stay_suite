                    ...
                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> <a href="{{ URL('admin/customer/edit/'.$user->id) }}"><button class="btn waves-effect waves-light btn-warning"><i class="mdi mdi-wrench"></i> </button></a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
...
<script>
    ...
    $(".js-switch").on('change', function() {
        ...
        $.ajax({
            url: "{{ url('admin/customer/status/update') }}" + '/' + customerID,
            type: 'POST',
            data: {
