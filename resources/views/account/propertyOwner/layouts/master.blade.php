...
<head>
    ...
    <link rel="stylesheet" href="{{ URL('dashboard_assets/css/sweetalert2.min.css') }}">
    @yield('styles')
</head>
...
<body>
    <!-- Begin page -->
    <div id="wrapper">
        @include('account.propertyOwner.layouts.topbar')
        @include('account.propertyOwner.layouts.sidebar')
        ...
        <div class="content-page">
            @yield('content')
            @include('account.propertyOwner.layouts.footer')
        </div>
        <!-- ============================================================== -->
        <!-- End Page content -->
        <!-- ============================================================== -->
    ...
    <script src="{{ URL('dashboard_assets/js/sweetalert2.min.js') }}"></script>
