...
return new class extends Migration
{
    public function up()
    {
        Schema::create('hotel_has_facilities', function (Blueprint $table) {
            ...
            $table->integer('property_facility_id')->unsigned()->index();
            $table->foreign('property_facility_id')->references('id')->on('hotel_facilities')->onDelete('cascade')->onUpdate('cascade');
